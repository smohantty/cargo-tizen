...
- `reference-projects/rpm-service-app` shows an RPM with extra source files (systemd unit, env config) in `tizen/rpm/sources/`, referenced as `Source1:`, `Source2:` in the spec.
